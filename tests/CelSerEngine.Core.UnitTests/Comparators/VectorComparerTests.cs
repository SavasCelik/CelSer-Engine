...
public class VectorComparerTests
{
    ...
    {
        var values = new short[] { 7, 452, 2, 7, 11, 19, 5, 2, 9, 26, 16, 452, 8, 17, 4, 7, 20, 10, 30, 13, 1, 25, 6, 12, 3, 24, 15, 30, 22, 21, 18, 27 };
        ...
        yield return new object[] { ScanCompareType.SmallerThan, values, "11", 13 };
        ...
        yield return new object[] { ScanCompareType.BiggerThan, values, "11", 18 };
    }
}   
